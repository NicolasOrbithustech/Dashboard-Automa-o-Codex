...
const COPY_ANGLES = [
  ...
  "catalogo: destacar que Koins podem ser usados para resgatar gift cards, recargas, cupons e outros premios disponiveis",
...
export async function generateSocialPost(input) {
  ...
  const prompt = [
    ...
    "Estrutura obrigatoria da legenda: 1) gancho diferente dos posts recentes; 2) explicacao rasa e simples do fluxo responder pesquisas -> acumular Koins -> resgatar gift cards/premios disponiveis; 3) CTA para clicar/acessar o link da bio.",
    ...
    "Quando fizer sentido, cite no maximo 1 ou 2 exemplos concretos de catalogo por post, como Uber, iFood, Netflix, Spotify, recargas ou cupons. Sempre ressalve disponibilidade conforme estoque/campanha/regras.",
...
export function buildImagePrompt(input) {
  ...
  return [
    ...
    "Primary composition: follow the requested composition variation, using a simple rewards dashboard, gift card cards labeled as plain text examples, recharge/coupon cards, progress/checklist elements, clean premium layout, and clear social-media ad structure.",
