...
const DEFAULT_COGNITO_ISSUER = "https://cognito-idp.us-east-2.amazonaws.com/us-east-2_fsv23otfO";
const DEFAULT_COGNITO_CLIENT_ID = "3035tmlje9mph30ngbbdl75p00";
...
function configuredIssuer() {
  return String(process.env.AWS_COGNITO_ISSUER || DEFAULT_COGNITO_ISSUER).replace(/\/+$/, "");
}

function configuredClientId() {
  return String(process.env.AWS_COGNITO_CLIENT_ID || DEFAULT_COGNITO_CLIENT_ID);
}
